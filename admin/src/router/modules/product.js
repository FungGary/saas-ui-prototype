...
export default {
  ...
  children: [
    ...
    {
      path: 'product_list_new',
      name: `${pre}productListNew`,
      meta: {
        title: '商品列表',
        auth: ['admin-store-storeProuduct-index'],
        keepAlive: true,
      },
      component: () => import('@/pages/product/product_list_new'),
    },
    {
      path: 'product_add_new/:id?',
      name: `${pre}productAddNew`,
      meta: {
        auth: ['admin-store-storeProuduct-index'],
        title: '商品新增/编辑页面',
        activeMenu: routePre + '/product/product_list_new',
      },
      component: () => import('@/pages/product/product_add_new'),
    },
    {
