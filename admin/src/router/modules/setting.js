...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      name: `${pre}agreementEdit`,
      meta: {
        auth: ['setting-agreement'],
        title: '协议编辑',
        activeMenu: routePre + '/setting/agreement',
      },
      component: () => import('@/pages/setting/agreement/edit'),
    },
    {
      path: 'agreement_category/index',
      name: `${pre}agreementCategory`,
      meta: {
        auth: ['setting-agreement-category'],
        title: '协议类型管理',
      },
      component: () => import('@/pages/setting/agreementCategory/index'),
    },
    {
      path: 'copyright',
      name: `${pre}copyright`,
      meta: {
        auth: ['setting-copyright'],
        title: '版权管理',
        keepAlive: true,
      },
      component: () => import('@/pages/setting/copyright/index'),
    },
    {
      path: 'agreement/create',
      name: `${pre}agreementCreate`,
      meta: {
        auth: ['setting-agreement'],
        title: '新增协议',
        activeMenu: routePre + '/setting/agreement',
      },
      component: () => import('@/pages/setting/agreement/create'),
    },
    {
