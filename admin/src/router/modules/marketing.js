...
export default {
  ...
  children: [
    ...
    {
      path: 'store_integral/list_new',
      name: `${pre}storeIntegralListNew`,
      meta: {
        auth: ['marketing-store_integral'],
        title: '积分商品新版',
        keepAlive: true,
      },
      component: () => import('@/pages/marketing/storeIntegral/list_new/index'),
    },
    {
      path: 'store_integral/add_edit/:id?',
      name: `${pre}storeIntegralAddEdit`,
      meta: {
        auth: ['marketing-store_integral-create'],
        title: '添加/编辑积分商品',
        activeMenu: routePre + '/marketing/store_integral/list_new',
      },
      component: () => import('@/pages/marketing/storeIntegral/add_edit/index'),
    },
    {
    ...
    {
      path: 'exchange_code/list',
      name: `${pre}exchangeCode`,
      meta: {
        auth: ['marketing-exchange_code'],
        title: '兑换口令列表',
        keepAlive: true,
      },
      component: () => import('@/pages/marketing/exchangeCode/index'),
    },
    {
      path: 'recharge_package',
      name: `${pre}rechargePackage`,
      meta: {
        title: '充值套餐列表',
        auth: ['marketing-recharge_package'],
      },
      component: () => import('@/pages/marketing/rechargePackage/index'),
    },
  ],
};
