...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import('@/pages/user/list_new/index'),
    },
    {
      path: 'level',
      name: `${pre}level`,
    ...
    },
    {
      ...
      name: `${pre}level_new`,
      meta: {
        auth: ['admin-user-level-index'],
        title: '用户等级',
      },
      component: () => import('@/pages/user/level_new/index'),
    },
    {
      path: 'level_new/edit/:id?',
      name: `${pre}level_edit`,
      meta: {
        auth: ['admin-user-level-edit'],
        title: '添加/编辑用户等级',
      },
      component: () => import('@/pages/user/level_new/edit'),
    },
    {
      path: 'group',
      name: `${pre}group`,
    ...
    },
    {
      ...
      name: `${pre}annotation_review`,
      meta: {
        auth: [],
        title: '标注评审',
      },
      component: () => import('@/pages/user/list_new/annotation-review'),
    },
  ],
};
